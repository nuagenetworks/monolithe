...
class NUIngressAdvancedForwardingTemplateEntry(NURESTObject):
    ...
    def __init__(self, **kwargs):
        """ Initializes a IngressAdvancedForwardingTemplateEntry instance
        ...
        self._fc_override = str()
        self._protocol = str()
        self._description = str()
        self._redirect_v_port_tag_id = str()
        ...
        self.expose_attribute(local_name=u"fc_override", remote_name=u"FCOverride", attribute_type=str, choices=[u'D', u'E', u'F', u'G', u'A', u'B', u'C', u'H', u'NONE'])
    ...
    def _get_redirect_v_port_tag_id(self):
        """ Get attribute redirect_v_port_tag_id

            VPort tag to which traffic will be redirected to, when ACL entry match criteria succeeds

        """
        return self._redirect_v_port_tag_id

    def _set_redirect_v_port_tag_id(self, value):
        """ Set attribute redirect_v_port_tag_id

            VPort tag to which traffic will be redirected to, when ACL entry match criteria succeeds

        """
        self._redirect_v_port_tag_id = value

    redirect_v_port_tag_id = property(_get_redirect_v_port_tag_id, _set_redirect_v_port_tag_id)
