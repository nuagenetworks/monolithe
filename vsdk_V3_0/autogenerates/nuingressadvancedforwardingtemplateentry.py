...
class NUIngressAdvancedForwardingTemplateEntry(NURESTObject):
    """ Represents a IngressAdvancedForwardingTemplateEntry object in Nuage VSD solution
        IMPORTANT: Do not override this object.
    """

    def __init__(self, **kwargs):
        """ Initialize a NUIngressAdvancedForwardingTemplateEntry instance """

        super(NUIngressAdvancedForwardingTemplateEntry, self).__init__()

        # Read/Write Attributes
        self.fc_override = None  #  Value of the Service Class to be overridden in the packet when the match conditions are satisfied - int
        self.redirect_v_port_tag_id = None  #  VPort tag to which traffic will be redirected to, when ACL entry match criteria succeeds - int
        ...
        self.expose_attribute(local_name=u"fc_override", remote_name=u"FCOverride", attribute_type=int)
        self.expose_attribute(local_name=u"redirect_v_port_tag_id", remote_name=u"redirectVPortTagID", attribute_type=int)
    ...
    def get_remote_name(cls):
        ...
        return u"ingressadvancedforwardingtemplateentry"
