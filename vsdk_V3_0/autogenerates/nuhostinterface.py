...
class NUHostInterface(NURESTObject):
    """ Represents a HostInterface object in Nuage VSD solution
        IMPORTANT: Do not override this object.
    """

    def __init__(self, **kwargs):
        """ Initialize a NUHostInterface instance """

        super(NUHostInterface, self).__init__()

        # Read/Write Attributes
        self.ip_address = None  #  IP address of the  interface - int
        self.mac = None  #  MAC address of the  interface, cannot be modified after creation. - int
