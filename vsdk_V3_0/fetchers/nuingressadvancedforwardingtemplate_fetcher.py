...
class NUIngressAdvancedForwardingTemplatesFetcher(NURESTFetcher):
    """ Represents a NUIngressAdvancedForwardingTemplates fetcher """

    @classmethod
    def managed_class(cls):
        """ This fetcher manages NUIngressAdvancedForwardingTemplate objects

            Returns:
                Returns the NUIngressAdvancedForwardingTemplate class
        """
