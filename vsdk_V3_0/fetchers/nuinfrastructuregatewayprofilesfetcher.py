...
class NUInfrastructureGatewayProfilesFetcher(NURESTFetcher):
    """ Represents a InfrastructureGatewayProfiles fetcher """

    @classmethod
    def managed_class(cls):
        """ This fetcher manages NUInfrastructureGatewayProfile objects

            Returns:
                Returns the NUInfrastructureGatewayProfile class
        """
