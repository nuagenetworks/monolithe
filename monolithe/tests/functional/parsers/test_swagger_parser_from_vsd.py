...
class SwaggerURLParserTests(FunctionalTest):
    ...
    def test_run_call_api_docs_entry_point(self):
        ...
        """
        parser = SwaggerParser(vsdurl='https://135.227.222.46:8443', path=None, apiversion=3.1)
        ...
        self.assertEqual(url, u'https://135.227.222.46:8443/web/docs/api/V3_1/schema/api-docs')
