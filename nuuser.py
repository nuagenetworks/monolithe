...
class NUUser(NURESTObject):
    ...
    def __init__(self):
        ...
        self.expose_attribute(local_name=u'username', remote_name=u'userName', display_name=u'user name', attribute_type=str, is_required=True, is_editable=False, is_login=True, is_unique=True, can_order=True, can_search=True)
