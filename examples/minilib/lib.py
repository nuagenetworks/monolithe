...
def _validate_task(task):
    ...
    if not task["status"]: return _create_error("status", "Invalid input", "This value is mandatory.")
    if not task["status"] in ("TODO", "DONE"): return _create_error("status", "Invalid input", "Invalid input")
    return None
